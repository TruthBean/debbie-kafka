...
public class KafkaModuleStarter implements DebbieModuleStarter {
    ...
    public void registerBean(ApplicationContext applicationContext, BeanInitialization beanInitialization) {
        DebbieBeanInfo<KafkaConfiguration> debbieBeanInfo = new DebbieBeanInfo<>(KafkaConfiguration.class);
    ...
    public void starter(DebbieConfigurationCenter configurationFactory, ApplicationContext applicationContext) {
        ...
        DebbieBeanInfo<ConsumerRecordsEventListener> beanInfo = infoFactory.getBeanInfo("consumerRecordsEventListener", ConsumerRecordsEventListener.class, true);
    ...
    public void postStarter(ApplicationContext applicationContext) {
        if (this.consumerFactory != null) {
            ...
            Set<DebbieBeanInfo<?>> methodBean = initialization.getAnnotatedMethodBean(KafkaConsumerListener.class);
            ...
            for (DebbieBeanInfo<?> info : methodBean) {
